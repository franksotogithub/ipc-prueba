...
@Component({
  selector: 'app-articulo-directorio-create',
  templateUrl: './articulo-directorio-create.component.html',
  styleUrls: ['./articulo-directorio-create.component.scss']
})
export class ArticuloDirectorioCreateComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.activatedRoute.params.subscribe((params: Params) => {
     ...
     this.articuloDirectorio.informante= informante;
